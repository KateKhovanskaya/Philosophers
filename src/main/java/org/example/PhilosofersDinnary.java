...
public class PhilosofersDinnary implements Runnable {

    CountDownLatch endMeals;
    private final Philosof philosof;
    private final Object monitor;

    public PhilosofersDinnary(CountDownLatch endMeals, Philosof philosof){
        this.endMeals = endMeals;
        this.philosof = philosof;
        this.philosof.setEndMeals(endMeals);
        this.monitor = PhilosofersDinnary.class;
    }
    @Override
    public void run(){
